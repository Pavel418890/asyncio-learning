...
class Future:
    ...
    # define result status of future
    _state = _PENDING
    # if future was completed or error occurred result store in this variable
    _result = None
    ...
    # message for CancelledError  if the Future is cancelled
    ...
    def set_exception(self, exception):
        ...
        if isinstance(exception, type):
            exception = exception()
        # because result of future stored in stop iteration exception
